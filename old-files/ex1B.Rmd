...
geom_histogram(aes(y=..density..), breaks = seq(0, 1000, by = 10)) +theme(plot.title = element_text(hjust = 0.5))+
xlim(c(0,1000)) + labs(title="Samples from gamma distribution", x="x", y="Density") +
stat_function(fun = f_testb, args = list(alpha), color = "red")
