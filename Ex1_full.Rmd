...
$$
Using basic integration theoru using a trivial substitution can we see $ \int_{-\infty}^{\infty} f(x) dx = c/\alpha$. Hence, since the normalizing constant is found by using that a PDF must integrate to 1, we get $c = \alpha$. 
